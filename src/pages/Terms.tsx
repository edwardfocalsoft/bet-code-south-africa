        ...
        <Card className="bg-betting-dark-gray border-betting-light-gray">
          ...
          <CardContent className="prose prose-invert max-w-none">
            <div className="space-y-6">
              ...
              <section>
                <Heading as="h2" size="2xl" className="mb-4">5. Oracle AI Predictions</Heading>
                <p>
                  The Oracle is an AI-powered prediction feature that uses real-time fixture data to generate betting suggestions. By using the Oracle, you acknowledge and agree that:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li>Predictions are generated by artificial intelligence and are not guarantees of any outcome.</li>
                  <li>Registered users receive a daily allowance of free Oracle predictions. Once that allowance is used, additional predictions are charged a per-scan fee. Both the daily allowance and the per-scan price are configured by BetCode admins and may change at any time.</li>
                  <li>Oracle prediction modes (Auto Pick and Image Upload) may be temporarily enabled or disabled by BetCode admins.</li>
                  <li>BetCode is not liable for any losses incurred from acting on Oracle predictions.</li>
                  <li>The Oracle uses third-party data sources (including SofaScore) and BetCode does not guarantee the accuracy or availability of this data.</li>
                  <li>You are solely responsible for any betting decisions made based on Oracle output.</li>
                </ul>
              </section>
              
              <section>
                <Heading as="h2" size="2xl" className="mb-4">6. Payments and Fees</Heading>
                <p>
              ...
              <section>
                <Heading as="h2" size="2xl" className="mb-4">7. Content Guidelines</Heading>
                <p>
