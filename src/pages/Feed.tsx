...
const MOCK_POSTS = [
  {
    ...
    avatar: 'TK',
    time: '2 hours ago',
    content: '5/5 wins yesterday. Today\'s acca looking solid — PSL fixtures are locked in. Trust the process.',
    hearts: 42,
    thumbsUp: 38,
    thumbsDown: 2,
  },
  {
    ...
    avatar: 'BW',
    time: '4 hours ago',
    content: 'Premier League weekend picks are up. Over 2.5 goals in 3 matches — check my ticket before kickoff.',
    hearts: 27,
    thumbsUp: 31,
    thumbsDown: 1,
  },
  ...
  },
  {
    ...
    avatar: 'AP',
    time: '12 hours ago',
    content: 'Free ticket dropped for the weekend. Follow me for daily free picks and premium combos.',
    hearts: 112,
    thumbsUp: 98,
    thumbsDown: 4,
  },
